...
impl DemoApp {
    pub(in crate::app) fn section_context_menu(&mut self, ui: &mut egui::Ui) {
        ...
        Card::new().show(ui, |ui| {
            ...
            card_header(
                ui,
                tr!(t::ContextMenuSec::HArea).as_ref(),
                Some(desc.as_ref()),
            );
    ...
    pub(in crate::app) fn section_drawer(&mut self, ui: &mut egui::Ui) {
        ...
        Card::new().show(ui, |ui| {
            ...
            if Button::new(tr!(t::DrawerSec::Open).as_ref())
                .show(ui)
                .clicked()
            {
    ...
    pub(in crate::app) fn section_hover_card(&mut self, ui: &mut egui::Ui) {
        ...
        Card::new().show(ui, |ui| {
            ...
            card_header(
                ui,
                tr!(t::HoverCardSec::HProfile).as_ref(),
                Some(desc.as_ref()),
            );
            Spacing::Sm.show(ui);
    ...
    pub(in crate::app) fn section_sheet(&mut self, ui: &mut egui::Ui) {
        ...
        Card::new().show(ui, |ui| {
            ...
            if Button::new(tr!(t::SheetSec::Open).as_ref())
                .show(ui)
                .clicked()
            {
    ...
    pub(in crate::app) fn section_tooltip(&mut self, ui: &mut egui::Ui) {
        ...
        Card::new().show(ui, |ui| {
            ...
            Tooltip::new(helpful.as_ref()).wrap(ui, |ui| {
                Button::new(tr!(t::TooltipSec::HoverMe).as_ref())
        ...
        Card::new().show(ui, |ui| {
            ...
            Tooltip::new(opens.as_ref()).wrap(ui, |ui| {
                Button::new(tr!(t::TooltipSec::CmdPalette).as_ref())
