...
impl DemoApp {
    pub(in crate::app) fn section_accordion(&mut self, ui: &mut egui::Ui) {
        self.section_title(ui, "Accordion", "A vertically stacked set of interactive headings that each reveal a section of content.");

        Card::new().show(ui, |ui| {
            card_header(ui, "FAQ", None);
    ...
    pub(in crate::app) fn section_menubar(&mut self, ui: &mut egui::Ui) {
        self.section_title(ui, "Menubar", "A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.");
    ...
    pub(in crate::app) fn section_navigation_menu(&mut self, ui: &mut egui::Ui) {
        self.section_title(ui, "Navigation Menu", "A collection of links for navigating websites.");
    ...
    pub(in crate::app) fn section_pagination(&mut self, ui: &mut egui::Ui) {
        self.section_title(ui, "Pagination", "Pagination with page navigation, next and previous links.");
    ...
    pub(in crate::app) fn section_tabs(&mut self, ui: &mut egui::Ui) {
        self.section_title(ui, "Tabs", "A set of layered sections of content — known as tab panels — that are displayed one at a time.");

        Card::new().show(ui, |ui| {
            card_header(ui, "Account", None);
