...
impl<'a> Badge<'a> {
    pub fn new(label: &'a str) -> Self {
        Self { label, variant: BadgeVariant::Default, size: Size::Default }
    }
    ...
    pub fn show(self, ui: &mut Ui) {
        ...
        let font_size = match self.size {
            Size::Sm => 11.0, Size::Default => 12.0, Size::Lg => 13.0,
        };
        let h_pad = match self.size {
            Size::Sm => 6.0, Size::Default => 10.0, Size::Lg => 14.0,
        };
        let v_pad = match self.size {
            Size::Sm => 1.0, Size::Default => 2.0, Size::Lg => 3.0,
        };
        ...
        if ui.is_rect_visible(rect) {
            ...
            painter.galley(egui::Pos2::new(rect.left() + h_pad, rect.top() + v_pad), galley, fg);
        }
    }
